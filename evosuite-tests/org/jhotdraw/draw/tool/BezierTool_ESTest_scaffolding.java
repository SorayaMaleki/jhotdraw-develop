...
public class BezierTool_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jhotdraw.draw.tool.BezierTool"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BezierTool_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jhotdraw.draw.tool.BezierTool$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BezierTool_ESTest_scaffolding.class.getClassLoader()); 
